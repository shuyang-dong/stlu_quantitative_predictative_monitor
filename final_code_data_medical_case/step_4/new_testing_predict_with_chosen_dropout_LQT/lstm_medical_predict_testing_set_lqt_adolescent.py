...
# evaluation with STL-U and dropout with loss func
...
output_folder = '/Medical_case/with_dropout/new_testing_predict_with_chosen_dropout_LQT/results/{p_type}_patient'.format(p_type=p_type)
mkdir(output_folder)
print('output_folder: ', output_folder)

# load trained lstm model
# adult model
adult_lstm_path = '/Medical_case/with_dropout/new_testing_predict_with_chosen_dropout_LQT/trained_model/lstm_s1_with_dropout_lr_0.01_dt_4_dr_0.9_e_50_3_m_8_f_adult_patient_state_dict.pt'
# child model
child_lstm_path = '/Medical_case/with_dropout/new_testing_predict_with_chosen_dropout_LQT/trained_model/lstm_s1_with_dropout_lr_0.01_dt_4_dr_0.9_e_50_3_m_8_f_child_patient_state_dict.pt'
# adolescent model
adolescent_lstm_path = '/Medical_case/with_dropout/new_testing_predict_with_chosen_dropout_LQT/trained_model/lstm_s1_with_dropout_lr_0.001_dt_4_dr_0.9_e_50_3_m_8_f_adolescent_patient_state_dict.pt'
