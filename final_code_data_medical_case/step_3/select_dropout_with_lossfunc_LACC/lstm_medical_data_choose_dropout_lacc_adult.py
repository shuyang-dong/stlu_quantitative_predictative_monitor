...
def lsat(trace_uncertain, trace_origin, requirement, beta_1=0, beta_2=0):
...
# evaluation with STL-U and dropout with loss func Lacc (lsat setting beta_1=beta_2=0)
...
# STL formula for monitor CGM value
...
num_epochs = 1
num_epochs_list = [1]
learning_rate_list = [0.001] # no use, just for unifying output file name
...
output_folder = '/Medical_case/with_dropout/select_dropout_with_lossfunc_LACC/results/{month}_m_{p_type}_patient_{feature_num}_f'.format(
