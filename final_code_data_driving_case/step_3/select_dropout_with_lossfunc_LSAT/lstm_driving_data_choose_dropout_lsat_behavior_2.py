...
route_id_list = [7]
episode_num = 50
trace_seed_list = [8, 7, 10, 3, 1, 11, 12, 0, 14, 6, 5, 13, 9, 4, 2]
...
# eval function for choosing dropout type and rate with Loss Lsat
...
def getconfdistloss(tr_pred, tr_orig):
    ...
    return cdf * 2 - 1
def lsat(trace_uncertain, trace_origin, requirement, predict_length, conf, beta_1=0.25, beta_2=0.25):
...
output_folder = '/home/cpsgroup/predictive_monitor_new_stl/with_dropout_new_stl/select_dropout_with_lossfunc_LSAT/results/behavior_type_{behavior_type}_f_{feature_num}'.format(
...
b2_lstm_path = '/home/cpsgroup/predictive_monitor_new_stl/lstm_checkpoint/behavior_type_2/lstm_s1_with_dropout_lr_0.001_dt_4_dr_0.9_e_300_behavior_type_2_f_17_state_dict.pt'
            ...
            if (epoch + 1) in num_epochs_list:
                ...
                for dropout_type in dropout_type_list:
                    for dropout_rate in dropout_rate_list:
                        ...
                        #print('dropout_type: ', dropout_type, ' dropout_rate: ', dropout_rate, ' dropout_dict: ', dropout_dict)
