...
output_folder = '/home/cpsgroup/predictive_monitor_new_stl/with_dropout_new_stl/select_dropout_with_lossfunc_LACC/results/behavior_type_{behavior_type}_f_{feature_num}'.format(
