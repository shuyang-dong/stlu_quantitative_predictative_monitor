...
class ScenarioOperation(object):
    ...
    def drive_as_behavior_agent(self, behavior_agent, i):
        #print('drive_as_behavior_agent.')
        self.other_actors[i].apply_control(behavior_agent.run_step())
        return

    def drive_as_basic_agent(self, basic_agent, i):
        #print('drive_as_behavior_agent.')
        self.other_actors[i].apply_control(basic_agent.run_step())
        return
