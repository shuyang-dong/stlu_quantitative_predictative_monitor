...
output_folder = '/home/cpsgroup/predictive_monitor_new_stl/with_dropout_new_stl/new_testing_predict_with_chosen_dropout_LACC/results/behavior_type_{behavior_type}_f_{feature_num}'.format(
